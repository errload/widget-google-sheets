...
// проверка файлов старта и паузы на наличие багов (жизни файла более 20 минут)
if (file_exists('google_sheets/start')) {
    ...
    if ($diff->i > 20) unlink('google_sheets/start');
}
...
if (file_exists('google_sheets/pause')) {
    ...
    if ($diff->i > 20) unlink('google_sheets/pause');
}
